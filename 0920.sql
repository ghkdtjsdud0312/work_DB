...
-- 외래키는 서로 다른 테이블 간 관계를 정의하는데 사용하는 제약 조건
-- 참조하고 있는 기본 키의 데이터타입과 일치해야 하며 외래키에 참조되는 기본키는 삭제할 수 없음
...
CREATE TABLE EMP_FK(
    ...
    SAL     NUMBER(7,2),
    COMM    NUMBER(7,2),
    DEPTNO  NUMBER(2) REFERENCES DEPT_FK(DEPTNO) -- 참조키 또는 외래키
);

INSERT INTO DEPT_FK VALUES(10, '농구부', '서울');
INSERT INTO EMP_FK VALUES (9000,'강백호', '농구', 8888, 2300, 1200, 10);
...
INSERT INTO TABLE_CHECK VALUES('JKS2024','SPIB2','010-5006-4146');

SELECT * FROM TABLE_CHECK;

-- DEFAULT 제약 조건 : 특정 열에 저장 할 값이 지정되지 않은 경우 기본값을 지정
